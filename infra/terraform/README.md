...
*Note: PostgreSQL and Redis are intentionally left out of this Terraform configuration. We expect you to bring your own managed database (e.g., RDS, Aurora, Supabase) and pass the connection string via `DATABASE_URL`.*
