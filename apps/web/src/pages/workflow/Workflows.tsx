...
export default function Workflows() {
  ...
  return (
    <div className="py-6 space-y-6">
      <WorkflowHeader onCreateClick={() => setIsCreateOpen(true)} />
...
function WorkflowHeader({ onCreateClick }: { onCreateClick: () => void }) {
  return (
...
interface CreateWorkflowFormProps {
  register: UseFormRegister<CreateWorkflowDto>;
  errors: FieldErrors<CreateWorkflowDto>;
  isSubmitting: boolean;
  onSubmit: (e: React.FormEvent) => void;
  onCancel: () => void;
}

function CreateWorkflowForm({ register, errors, isSubmitting, onSubmit, onCancel }: CreateWorkflowFormProps) {
  return (
...
function WorkflowList({ workflows }: { workflows: WorkflowResponse[] }) {
  return (
